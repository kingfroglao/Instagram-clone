...
const submitUpdatedPost = (postId, newText) => {
            ...
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                ...
                <div class="md:max-w-[500px] w-full relative">
                    ...
                    <div class="overflow-y-auto h-[calc(100%-170px)]">
                        ...
                        <div id="postPopup" v-if="showPostPopup" class="bg-white-500 fixed top-20 left-0 w-full">
                            <div style="background-color: white; margin: 100px auto; padding: 20px; width: 50%;">
                                <label for="postContent">New Text:</label>
                                <textarea id="postContent" v-model="newPostText" style="width: 100%; height: 200px;" placeholder="Enter post content"></textarea>
                                <button @click="submitUpdatedPost(post.id, newPostText)">Submit</button>
                                <br>

...
const goToSearch = (object) => {
    router.post('/search'); // 确保你有一个对应的路由
}
...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        <!-- Top Nav Bar -->
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-0 md:hidden block w-full bg-white h-[61px] border-b border-b-gray-300">
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img class="w-[105px] ml-6 cursor-pointer" src="/insta-logo.png" alt="insta logo">
                </Link>
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            ...
            <div class="px-3">
                ...
                <Link :href="route('users.show', { id: $page.props.auth.user._id })">
